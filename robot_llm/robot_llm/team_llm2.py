...
option_list = [
    ...
    #     example_code="node.assemble_at(goal='round table', team_name=team_name, robots=['burger1', 'waffle', 'robot6'])"
    # ),
    TestOption(
        name="goto",
        id=2,
        description="This is used to goto only after robots are already in formation. Both team_name and robots list are automatically provided.",
        example_code="node.goto(goal='fridge', team_name=team_name, robots=['burger1', 'waffle', 'robot6'])"
    )
]
...
class TeamLLMNode(Node):
    ...
    def assemble(self, team_name: str = None, robots: list[str] = None) -> bool:
        ...
        time.sleep(3)  # TODO: Replace with actual status monitoring
