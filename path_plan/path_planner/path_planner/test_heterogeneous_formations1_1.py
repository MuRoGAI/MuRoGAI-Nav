...
from agents1 import HeterogeneousFormationAgent, HolonomicAgent, DifferentialDriveAgent
# ============================================================
# Workspace + Map
# ============================================================

grid = np.load('restaurant_4.npy')
res = 0.1
...
#         [-0.33, -1.0],   # Robot 1: Diff-drive
#         [0.66, 0.0]    # Robot 2: Diff-drive
#     ],
#     robot_types=['diff-drive', 'diff-drive', 'diff-drive'],
#     radius=[0.25, 0.25, 0.25],       # per-robot radii
#     v_max=[0.2, 0.2, 0.2],           # per-robot velocity
#     omega_max=[0.4, 0.4, 0.4],       # per-robot angular vel (0 for holonomic)
#     a_max=[0.4, 0.4, 0.4],           # per-robot linear accel
#     alpha_max=[3.5, 3.5, 3.5],       # per-robot angular accel (0 for holonomic)
# )
...
agents = [
    ...
    #  np.array([12.0, 10.8, 0.0, 1.8, 1.8]),
