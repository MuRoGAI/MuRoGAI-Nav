...
grid = np.load('restaurant_map.npy')
res = 0.1
...
hetero_form1 = HeterogeneousFormationAgent(
    P_star=[
        [-0.33,  1.0],   # Robot 0: Diff-drive
        [-0.33, -1.0],   # Robot 1: Holonomic
        [ 0.66,  0.0]    # Robot 2: Diff-drive
    ],
...
hetero_form2 = HeterogeneousFormationAgent(
    ...
    robot_types=['holonomic', 'holonomic', 'diff-drive'],
    radius=0.5,
)
# ============================================================
...
agents = [
    ("HeteroForm1", hetero_form1,
     np.array([4.33, 5.0, 0.0, 1.0, 1.0]),   # start pose | find this using all robots in the formation with odom_world topic
     np.array([15.33, 9.0, 0.0, 1.0, 1.0]),  # goal
     "heterogeneous-formation",
     {  # Per-robot velocity limits
         'v_max': [0.15, 0.15, 0.15],   # Robot 0: 0.6, Robot 1: 0.8, Robot 2: 0.7
         'w_max': [1.0, 1.0, 1.0],   # omega limits (0 for holonomic)
         'a_max': 0.3,
     }),

    ("HeteroForm2", hetero_form2,
     np.array([15.66, 9.0, 0.0, 1.0, 1.0]),  
     np.array([4.33, 5.0, 0.0, 1.0, 1.0]),   
     "heterogeneous-formation",
     {  # Per-robot velocity limits
         'v_max': [0.15, 0.15, 0.15],   # Robot 0: 0.6, Robot 1: 0.8, Robot 2: 0.7
         'w_max': [1.0, 1.0, 1.0],   # omega limits (0 for holonomic)
...
colors = {
    "DD": "tab:blue",   # add diff colour for each set 
    "Holo": "tab:red",
    "HeteroForm1": "tab:red",
    "HeteroForm2": "tab:purple",
}
