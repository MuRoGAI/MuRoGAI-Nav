...
burger1 = DifferentialDriveAgent(
    radius=0.15, v_max=0.2, omega_max=2.5,
    a_max=2.4, alpha_max=2.5, inflation=INFLATION_RADIUS,
)

waffle = DifferentialDriveAgent(
    radius=0.23, v_max=0.23, omega_max=1.5,
    a_max=2.2, alpha_max=3.0, inflation=INFLATION_RADIUS,
)


firebird = DifferentialDriveAgent(
    radius=0.27, v_max=0.5, omega_max=2.5,
    a_max=2.5, alpha_max=3.5, inflation=INFLATION_RADIUS,
)
...
for name, agent, start, goal, agent_type in agents:
    ...
    planner = SIRRT(
        ...
        neighbor_radius=2.0,
        precision=2,
        seed=644, #101 #66 #616 #51 #352 # 360 #361, # 364
        debug=False,
