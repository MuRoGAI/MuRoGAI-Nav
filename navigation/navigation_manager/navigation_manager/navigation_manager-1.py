...
class NavigationManager(Node):
    def __init__(self):
        ...
        self.map_metadata_path = self.resolve_file(
            "map_metadata_file", "navigation_manager", "data/restaurant.json"
        )
        self.map_image_path = self.resolve_file(
            "map_image_file", "navigation_manager", "data/restaurant.png"
        )
        ...
        eg_formation = {
            "F1": {
                ...
                "desired_radius": 1.0,
                "robots": [
                    { "robot": "robot1", "x": 3.0, "y": 6.3, "yaw": 1.5, "radius": 0.25, "max_acceleration": 0.4, "max_linear_velocity_x": 0.3, "max_angular_velocity_z": 0.5, "colour": "blue", "type": "Differentail Drive Robot" },
                    { "robot": "robot2", "x": 4.0, "y": 6.3, "yaw": 0.5, "radius": 0.25, "max_acceleration": 0.4, "max_linear_velocity_y": 0.3, "max_linear_velocity_x": 0.3, "max_angular_velocity_z": 0.5, "colour": "blue", "type": "Omnidirectional Drive Robot"}
                ]
            },
            "R1": [
                { "robot": "robot7", "x": 3.5, "y": 3.2, "yaw": 2.6 , "radius": 0.25, "max_acceleration": 0.4, "max_linear_velocity_x": 0.3, "max_linear_velocity_y": 0.3, "max_angular_velocity_z": 0.5, "colour": "orange", "type": "Holonomic Drive Robot"}
            ],
            "R2": [
                { "robot": "robot10", "x":9.4, "y": 7.3, "yaw": 2.6 , "radius": 0.55, "max_acceleration": 0.4, "max_linear_velocity_x": 0.3, "max_linear_velocity_y": 0.3, "max_angular_velocity_z": 0.5, "colour": "yellow", "type": "Omnidirectional Drive Robot"}
            ],
            "F2": {
                "centroid_x": 4.2,
                "centroid_y": 5.0,
                ...
                "desired_radius": 1.5,
                "robots": [
                    { "robot": "robot5", "x": 6.6, "y": 6.3, "yaw": 1.5, "radius": 0.25, "max_acceleration": 0.4, "max_linear_velocity_x": 0.3, "max_angular_velocity_z": 0.5, "colour": "green", "type": "Differentail Drive Robot" },
                    { "robot": "robot4", "x": 3.0, "y": 2.3, "yaw": 1.5, "radius": 0.25, "max_acceleration": 0.4, "max_linear_velocity_x": 0.3, "max_linear_velocity_y": 0.3, "max_angular_velocity_z": 0.5, "colour": "green", "type": "Holonomic Drive Robot" },
                    { "robot": "robot6", "x": 3.0, "y": 6.3, "yaw": 3.6, "radius": 0.25, "max_acceleration": 0.4, "max_linear_velocity_x": 0.3, "max_angular_velocity_z": 0.5, "colour": "green", "type": "Differentail Drive Robot" }
                ]
            },
            "R3": [
                { "robot": "robot15", "x":6.4, "y": 2.5, "yaw": 0.0 , "radius": 0.55, "max_acceleration": 0.4, "max_linear_velocity_x": 0.3, "max_angular_velocity_z": 0.5, "colour": "red", "type": "Differentail Drive Robot"}
            ],
        }
    ...
    def update_robot_goal_memory(self, plan: dict):
        """
    ...
    def navigate_request_callback(self, msg: NavigationRobotRequest):
        ...
        self.get_logger().info(
            f"[Navigation Request] Robot: '{robot_namespace}' | Goal: '{target_goal}'"
        )
    ...
    def request_plan(self, trigger: str, robot_name: str, goal, formation_robots):
        ...
        try:
            ...
            # Update goal memory
            self.update_robot_goal_memory(plan_json)
